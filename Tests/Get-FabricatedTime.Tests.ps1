<#-------------------------------------------------------------------------------------------------
  Data Fabricator - Get-FabricatedTime.Tests.ps1
...
Describe "DataFabricator Get-FabricatedTime.Tests" {
  ...
  Context "<module> <function> Tests" {
    It "<function> matches a pattern of 23:59:59" {
      Get-FabricatedTime | Should -Match '\d{2}:\d{2}:\d{2}'
    }

    It "<function> matches a pattern of 12:59:59 AM" {
      Get-FabricatedTime -AMPM | Should -Match '\d{2}:\d{2}:\d{2} [AP]M'
    }
